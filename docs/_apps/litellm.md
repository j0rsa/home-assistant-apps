...
faq:
  - q: "Why won't the LiteLLM app start?"
    a: "Verify the database_url is correct and the PostgreSQL database is reachable. Also check that master_key and salt_key are non-empty strings in the configuration. If logs show GLIBC_2.44 not found, update to app version 1.99.0-2 or later."
...
- If logs show `GLIBC_2.44' not found`, update to app version 1.99.0-2 or later
